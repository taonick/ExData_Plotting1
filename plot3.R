#This script makes a plot for the third part of assignment for exploratory data analysis ob coursera

#Sorry that the weekday abbreviatures appear in Russian. That a the system feature, could not change it in R
